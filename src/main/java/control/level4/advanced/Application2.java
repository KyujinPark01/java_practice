...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        if (total_price >= 50000000) {
            bonus = 5;
        } else if (total_price >= 30000000) {
            bonus = 3;
        } else if (total_price >= 10000000) {
            bonus = 1;
        }

        System.out.println("매출액 : " + total_price);
        System.out.println("보너스율 : " + bonus+"%");
        System.out.println("월 급여 : " + salary);
        System.out.println("보너스 금액 : " + total_price * bonus / 100);
        System.out.println("=====================================");
        System.out.println("총 급여 : " + (total_price * bonus / 100 + salary));
